...
import { HiArrowRight, HiCode, HiCursorClick } from 'react-icons/hi';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-gray-600 dark:text-gray-400 mb-10 text-lg max-w-xl"
            >
              {t('hero.subtitle')}
            </motion.p>
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white rounded-lg font-semibold flex items-center justify-center gap-2 shadow-lg shadow-primary-500/50 transition-all duration-300"
              >
                {t('hero.cta')}
              ...
              <motion.button
                ...
                className="px-8 py-4 border-2 border-primary-500 text-primary-400 hover:bg-primary-500 hover:text-white rounded-lg font-semibold transition-all duration-300"
              >
                {t('hero.cta2')}
              </motion.button>
            </motion.div>
          ...
          >
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <motion.div
                ...
                className="relative bg-gradient-to-br from-primary-500/20 to-purple-500/20 rounded-2xl p-8 backdrop-blur-sm border border-primary-500/30"
              >
                <div className="aspect-square bg-gradient-to-br from-primary-600 to-purple-600 rounded-xl flex items-center justify-center">
